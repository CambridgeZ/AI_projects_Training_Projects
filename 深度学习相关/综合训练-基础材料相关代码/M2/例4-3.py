# -*- coding: utf-8 -*-
"""
Created on Fri Jun 10 10:39:05 2022
...
def res_identity(input_tensor,conv_depth,kernel_shape,layer_name):
    with tf.variable_scope(layer_name):
        relu = tf.nn.relu(tf.keras.layers.Conv2D(conv_depth, kernel_shape)(input_tensor))
        outputs = tf.nn.relu(tf.keras.layers.Conv2D(conv_depth, kernel_shape)(relu) + input_tensor)
    return outputs
